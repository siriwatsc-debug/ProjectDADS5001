...
* จากข้อมูลการเกิดเหตุการณ์แผ่นดินไหวในประเทศไทยและภูมิภาคโดยรอบ เป็นเวลา 18 ปี นับตั้งแต่ปี 2007 จนถึงปี 2025 มีแนวโน้มที่สูงขึ้น [Part II](#part-ii)
* ข้อมูลแผ่นดินไหวของประเทศไทยเมื่อเทียบกับประเทศในภูมิภาคเดียวกัน 
    * จำนวนการเกิดแผ่นดินไหวของประเทศไทยสูงเป็นอันดับ 2 (3677 ครั้ง) รองจากพม่า (8004 ครั้ง) ในช่วงเวลา ปี 2007 ถึง 2025 [Part II](#part-ii) (Part II - Top 10 country)
    * สาเหตุหลัก ที่มีแนวโน้มการเกิดแผ่นดินไหวมากกว่าประเทศอื่นในภูมิภาคนี้เพราะอยู่ใกล้บริเวณรอยเลื่อนของแผ่นเปลือกโลกที่ยังคงเคลื่อนตัวอยู่ ( Indian plat movement )
...
* ภูมิภาคและจังหวัดที่มีการเกิดแผ่นดินไหวในประเทศไทย
    ...
    * สาเหตุของภูมิภาคและจังหวัดที่มีการเกิดแผ่นดินไหวมากกว่า ส่วนอื่น เพราะอยู่ใกล้บริเวณรอยเลื่อนของแผ่นเปลือกโลกที่ยังคงเคลื่อนตัวอยู่ [Active Fault](#active-fault)
* พื้นที่ใดในประเทศไทยมีความเสี่ยงและปลอดภัยต่อการเกิดแผ่นดินไหว 
    * จังหวัดที่เป็นพื้นที่เสี่ยงสูงสุด 5 อันดับ : เชียงราย เชียงใหม่ แม่ฮ่องสอน ลำปาง และ ตาก
    * จังหวัดที่เป็นพื้นที่เสี่ยงต่อการเกิดแผ่นดินไหวทั้งหมด : 34 จังหวัด
    * จังหวัดที่ไม่เคยเกิดแผ่นดินไหวจำนวน 43 จังหวัด ส่วนใหญ่อยู่ในภาคตะวันออก และภาคตะวันออกเฉียงเหนือ อยู่ห่างจากแนวเคลื่อนตัวของแผ่นเปลือกโลกหลัก
* ปัจจัยหนึ่งที่มีผลต่อการเกิดแผ่นดินไหวคือการเคลื่อนตัวของแผ่นเปลือกโลก Plate Movement
